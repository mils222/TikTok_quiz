...
import com.example.tiktokquiz.databinding.ActivityTiktokFirstLevelBinding


class TikTokFirstLevelActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTiktokFirstLevelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTiktokFirstLevelBinding.inflate(layoutInflater)
