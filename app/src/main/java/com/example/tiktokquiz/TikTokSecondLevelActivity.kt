...
import com.example.tiktokquiz.databinding.ActivityTiktokSecondLevelBinding

class TikTokSecondLevelActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTiktokSecondLevelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTiktokSecondLevelBinding.inflate(layoutInflater)
